...
import antiquite from "../data/HistoireAntiquite.json";
  ...
  return (
    ...
    >
      <h1 className="font-mainFont text-dynamic-2xl font-bold max-lg:text-dynamic-xl max-lg:leading-normal">
        <HighlightSearch
          text="La langue des signes durant l'Antiquité"
      ...
      <div className="flex flex-row items-start justify-between max-xl:flex-col">
        <div className="flex flex-col items-center w-3/4 max-xl:w-full">
          <div className="m-6 mb-10 w-full max-lg:m-0" aria-live="polite">
            <p className="mx-5 max-lg:mx-3">
              <HighlightSearch text={antiquite.article} searchTerm={searchTerm} />
            </p>
          </div>
        </div>
        ...
        <div className="relative flex flex-col items-center max-xl:my-5 max-xl:m-auto">
          <img
            src={import.meta.env.VITE_APP_BASE_URL + "images/AntiquiteLS.png"}
            width={390}
          ...
          />
          <img
            src={import.meta.env.VITE_APP_BASE_URL + "images/AntiquiteLSDark.png"}
            width={390}
            alt="Portrait de Aristote"
          ...
          <a
            ...
            aria-label="Voir la source du portrait de Aristote"
            className="absolute -bottom-7 text-end text-dynamic-sm hover:underline hover:translate-x-[1px] hover:translate-y-[1px] max-lg:text-dynamic-xsm"
          >
      ...
      <div className="m-6 mb-10 max-lg:m-0" aria-live="polite">
        ...
        <ul className="mx-10 list-disc">
          <li className="hover:translate-x-[1px] hover:translate-y-[1px]">
            <a
              href={antiquite.bibliographie[1].lien}
              target="_blank"
              rel="noopener noreferrer"
              aria-label={`Visiter le lien externe pour ${antiquite.bibliographie[1].nom}`}
              className="flex flex-row items-center hover:underline"
            >
              <HighlightSearch
                text={antiquite.bibliographie[1].nom}
                searchTerm={searchTerm}
              />
              <ExternalLink
                size={24}
          ...
          <li className="hover:translate-x-[1px] hover:translate-y-[1px]">
            <a
              href={antiquite.bibliographie[2].lien}
              target="_blank"
              rel="noopener noreferrer"
              aria-label={`Visiter le lien externe pour ${antiquite.bibliographie[2].nom}`}
              className="flex flex-row items-center hover:underline"
            >
              <HighlightSearch
                text={antiquite.bibliographie[2].nom}
                searchTerm={searchTerm}
              />
              <ExternalLink
                size={24}
