  ...
  return (
    <main className='flex-grow flex items- my-6 mx-24'>
      <div className='w-3/4 mr-10'>
        <div className='mb-6'>
          <h1 className='text-heading font-bold'>Ressources pour découvrir la LSF</h1>
          <p className='text-bodyText text-justify m-2'>La page Médias met à votre disposition des ressources variées pour explorer la Langue des Signes Française (LSF) et mieux comprendre son univers. Vous y découvrirez une sélection de contenus multimédias tels que :</p>
        </div>
      ...
      <img src="/images/MediasPic.png" width={450} alt="" />
