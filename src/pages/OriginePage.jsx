      ...
      <div className='m-6 mb-10'>
        ...
        <ul className='mx-10 list-disc text-bodyText'>
          <li className='hover:translate-x-[1px] hover:translate-y-[1px]'>
            <a href="https://adsignes.fr/histoire-langue-des-signes" target='_blank' className='hover:underline'>https://adsignes.fr/histoire-langue-des-signes</a>
          </li>
          <li className='hover:translate-x-[1px] hover:translate-y-[1px]'>
            <a href="https://www.surdi.info/langue-des-signes-francaise-lsflangue-des-signes-siecles-histoire" target='_blank'className='hover:underline'>https://www.surdi.info/langue-des-signes-francaise-lsflangue-des-signes-siecles-histoire</a>
          </li>
          <li className='hover:translate-x-[1px] hover:translate-y-[1px]'>
            <a href="https://des-mains-et-des-signes.fr/la-lsf" target='_blank'className='hover:underline'>https://des-mains-et-des-signes.fr/la-lsf</a>
          </li>
          <li className='hover:translate-x-[1px] hover:translate-y-[1px]'>
            <a href="https://fr.wikipedia.org/wiki/Langue_des_signes_fran%C3%A7aise" target='_blank'className='hover:underline'>https://fr.wikipedia.org/wiki/Langue_des_signes_fran%C3%A7aise</a>
          </li>
        </ul>
      </div>
